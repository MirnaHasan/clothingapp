                        ...
                        if (userName.text.isEmpty ||
                          ...
                          Get.snackbar(
                           ...
                           'Password must be at least 6 characters',
                            ...
                            messageText: const Text(      'Password must be at least 6 characters',style: TextStyle(color: Colors.white,fontSize: 16,fontWeight: FontWeight.bold)  ,),
                            icon: const Icon(
                              Icons.warning,
                              color: Colors.white,
                            ),
